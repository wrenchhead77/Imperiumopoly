...
public class Player : MonoBehaviour
{
    ...
    public bool isInJail; // New field to track Jail status
    public int turnsInJail; // Optional: Track how many turns they've been in Jail
...
IEnumerator MoveToSpot(bool _isPassGo, int diceRoll, ePos? targetPosition = null, bool collect200 = false)
{
    ...
    for (int i = 1; i <= diceRoll; i++)
    {
        ...
        while (elapsedTime < duration)
        {
            ...
            // Update the center camera dynamically to follow the piece
    ...
    public void SetLandingSpot()
    {
        ...
        switch (so_Spot.spotType)
        {
            ...
            case eSpotType.tax:
                Hud.Instance.HandleSpot(so_Spot);
                break;
